...
public class CopyrightGUI : InteractableOverlay
{
	...
	public CopyrightGUI(IAmorous game)
		: base(game)
	{
		_QVqIVxBeF2SAQh6HDFwwp2RFmXB("Assets/Scenes/MainMenu/Version", "Assets/Scenes/MainMenu/Version hover", "Assets/Gui/Fonts/Bold-14", "Options", Color.White, 1417, 1000, new Microsoft.Xna.Framework.Rectangle(1417, 1000, 146, 58), ConfigureOptions);
