...
public class CensoredSexscene : _TwlwMC1hhdSzamwGWEBxuUkz1gH
{
	private class Particle
	{
		...
		public Particle()
		{
			while (true)
			{
				...
				{
					uint num2;
					switch ((num2 = (uint)num ^ 0xF7711475u) % 3u)
					{
					case 2u:
						goto IL_0008;
					default:
					...
					num = (int)(num2 * 90118251) ^ -2042657818;
				}
			}
		}
		...
		private void _haICL4qkfkOLhPhofWQH1GmjZx5()
		{
			...
			while (true)
			{
				...
				{
					uint num2;
					switch ((num2 = (uint)num ^ 0x41B43EABu) % 6u)
					{
					case 4u:
		...
		public void _tiBFUHPEkedkbgvuX3whdeyjhKo(float float_0)
		{
			...
			while (true)
			{
				...
				{
					uint num2;
					switch ((num2 = (uint)num ^ 0x89C53D42u) % 8u)
					{
					case 7u:
					{
						int num6;
	...
	public override void _tiBFUHPEkedkbgvuX3whdeyjhKo(GameTime gameTime_0)
	{
		...
		while (true)
		{
			...
			{
				uint num2;
				switch ((num2 = (uint)num ^ 0x352EC6D9u) % 8u)
				{
				case 7u:
				{
					int num8;
				...
				case 5u:
					...
					num = ((int)num2 * -1358060681) ^ 0x21830642;
					continue;
				case 3u:
					num5 = (float)(timeSpan.TotalMilliseconds / 1000.0);
					num = ((int)num2 * -258024692) ^ 0x791C434A;
					continue;
				case 2u:
					_Ja1biX4ByqpjkgcLg9SPPz8y4itA -= num5;
					num = ((int)num2 * -1507994533) ^ 0x865E681;
					continue;
				case 1u:
					timeSpan = CensoredSexscene.smethod_11(gameTime_0);
					num = ((int)num2 * -200952565) ^ -295628823;
					continue;
				case 4u:
					break;
				default:
				{
					using List<Particle>.Enumerator enumerator = _lpzETYXyRHxYihXrkJactMysoTi.GetEnumerator();
					while (true)
					{
						int num3;
						int num4;
						...
						while (true)
						{
							switch ((num2 = (uint)num3 ^ 0x352EC6D9u) % 4u)
							{
							case 3u:
							{
								Particle current = enumerator.Current;
								current._tiBFUHPEkedkbgvuX3whdeyjhKo(num5);
								num3 = 87998872;
								continue;
							}
							case 0u:
	...
	public override void _f5ctqAmdNsZ889UjM4LxDm8WGxA(SpriteBatch spriteBatch_0, SkeletonMeshRenderer skeletonMeshRenderer_0)
	{
		...
		Particle current = default(Particle);
		while (true)
		{
			int num = -235562876;
			while (true)
			{
				uint num2;
				switch ((num2 = (uint)num ^ 0xF88886DDu) % 4u)
				{
				case 1u:
					if (CensoredSexscene.smethod_9())
					{
						num = (int)((num2 * 836497534) ^ 0x46D7F013);
						continue;
					}
					return;
				case 0u:
					CensoredSexscene.smethod_12(spriteBatch_0);
					num = (int)((num2 * 1084246791) ^ 0x1EBF744B);
					continue;
				case 3u:
					break;
				default:
				{
					using (List<Particle>.Enumerator enumerator = _lpzETYXyRHxYihXrkJactMysoTi.GetEnumerator())
					{
						while (true)
						{
							...
							while (true)
							{
								switch ((num2 = (uint)num3 ^ 0xF88886DDu) % 5u)
								{
								case 4u:
									current._f5ctqAmdNsZ889UjM4LxDm8WGxA(_tt9eBN54CTaryoKDBFZI2D44oni, spriteBatch_0);
									num3 = ((int)num2 * -2146008895) ^ -796683800;
									continue;
								case 2u:
