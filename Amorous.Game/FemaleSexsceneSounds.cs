...
{ // _sg4TvSTYoH0YwumBfYnvr7IeDaT
	private static FemaleSexsceneSounds singleton;

	public FemaleSexsceneSounds(ContentManager content) : base(content)
	{
	...
	public static FemaleSexsceneSounds GetSingleton(ContentManager content)
	{
		return singleton ?? (singleton = new FemaleSexsceneSounds(content));
	}
}
