...
{ // _xJL9E6vKdg1LYZtKQU5RQKikpvE
	[JsonProperty("Name")]
	public string Name { get; set; }

	[JsonProperty("BodyType")]
	public PlayerData.EBodyType BodyType { get; set; }
	...
	public PlayerData.EHeadType HeadType { get; set; }
	...
	public PlayerData.EHeadMarkingsType HeadMarkingsType { get; set; }
	...
	public PlayerData.EHeadAccessoriesType HeadAccessoriesType { get; set; }
	...
	public PlayerData.EEyesType EyesType { get; set; }
	...
	public PlayerData.EBrowType BrowType { get; set; }

	[JsonProperty("BrowColor")]
	public Color BrowColor { get; set; }

	[JsonProperty("MuzzleType")]
	public PlayerData.EMuzzleType MuzzleType { get; set; }
	...
	public PlayerData.EHairstyleType HairstyleType { get; set; }

	[JsonProperty("HairColor")]
	public Color HairColor { get; set; }

	[JsonProperty("FringeType")]
	public PlayerData.EFringeType FringeType { get; set; }

	[JsonProperty("FringeColor")]
	public Color FringeColor { get; set; }

	[JsonProperty("FeetType")]
	public PlayerData.EFeetType FeetType { get; set; }

	[JsonProperty("FeetColor")]
	public Color FeetColor { get; set; }

	[JsonProperty("TailType")]
	public PlayerData.ETailType TailType { get; set; }
	...
	public PlayerData.EMarkingsType MarkingsType { get; set; }
	...
	public PlayerData.ECockType CockType { get; set; }
	...
	public PlayerData.EBallsType BallsType { get; set; }

	[JsonProperty("BallsColor")]
	public Color BallsColor { get; set; }

	[JsonProperty("BreastsType")]
	public PlayerData.EBreastsType BreastsType { get; set; }
