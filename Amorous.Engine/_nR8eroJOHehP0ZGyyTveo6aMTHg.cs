...
public class _nR8eroJOHehP0ZGyyTveo6aMTHg
{
	public class _2MhByyFij8YJN7lWVuu8gpYhGCy
	{
		...
		{
			int _Enec98mrCn8lf4R9d5oYrOaqFsd = nullable_0 ?? _Hnb6mPvrZFgOMCIApIeMW88jSsF._AIGmDXsiQSNuMA0DMoTOXVRh4Du;
		...
		public bool _tiBFUHPEkedkbgvuX3whdeyjhKo(GameTime gameTime_0)
		{
			if (_SWODlbUkQEqfwrtprjLPOeGF7HO != null && _3ITTZcgkF3r3Sr09GXF6V8n6iDH != null)
			{
				...
				{
					int _4yqSx4qQVhHNfyjCxxZbsvtLpfN = _3ITTZcgkF3r3Sr09GXF6V8n6iDH._GUdPCTGCrEJpuEchc38clNBP3ZAA;
					_3GMZuOfG1tyI9A65sJfkkPLAGdr _3GMZuOfG1tyI9A65sJfkkPLAGdr2 = _Hnb6mPvrZFgOMCIApIeMW88jSsF._wRdzAjzdiHzwF9UpkmHGZkGazqn.FirstOrDefault((_3GMZuOfG1tyI9A65sJfkkPLAGdr _3GMZuOfG1tyI9A65sJfkkPLAGdr_0) => _3GMZuOfG1tyI9A65sJfkkPLAGdr_0._WCJjJQRlVoZM67usdV2f1OR3arG == _4yqSx4qQVhHNfyjCxxZbsvtLpfN);
	...
	public void _4hlxzMzKSbVTbZUrEsP3dfw4x0h(int int_0, int? nullable_0 = null)
	{
		...
		{
			_FMuxd8PX5exXCoRNDVuFFbnirof fMuxd8PX5exXCoRNDVuFFbnirof = _Hnb6mPvrZFgOMCIApIeMW88jSsF._qzCM74gUrxJlbPAzupibdtIUUUg.FirstOrDefault((_FMuxd8PX5exXCoRNDVuFFbnirof _FMuxd8PX5exXCoRNDVuFFbnirof_0) => _FMuxd8PX5exXCoRNDVuFFbnirof_0._8NBsjeWoi7V64KoA9ZtIybPpcom == int_0);
			...
			{
				_ETHljYp3aQy9GQ1ZAzhfOYDI1sO._IGmWy5uYuv50rXGtBNbMPGzJhWh("Failed to find stage '{0}' in cutscene '{1}'", int_0, _Hnb6mPvrZFgOMCIApIeMW88jSsF._RB8fRXeQvK5vs7JEA0XfVCEpg1i);
			}
		}
	}
