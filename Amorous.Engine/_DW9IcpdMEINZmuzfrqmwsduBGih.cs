...
public class _DW9IcpdMEINZmuzfrqmwsduBGih
{
	...
	public static void _7cuPUL8aamrg9daETH6zQk3RwbF(int int_0, _lRHDfpOTd4PxClZkjMpoakPEA9d _lRHDfpOTd4PxClZkjMpoakPEA9d_0, string string_0 = "save")
	{
		...
		while (true)
		{
			...
			{
				uint num2;
				switch ((num2 = (uint)num ^ 0x7846867Au) % 3u)
				{
				case 1u:
					goto IL_000f;
				default:
				...
				num = ((int)num2 * -1617692648) ^ 0x679EBEF8;
			}
		}
	}
	...
	public static _lRHDfpOTd4PxClZkjMpoakPEA9d _sabDA8yXNR8DIRSbHjOcXx1e1Ax(int int_0, string string_0 = "save")
	{
		...
		try
		{
			...
			while (true)
			{
				...
				{
					uint num2;
					switch ((num2 = (uint)num ^ 0x8ADEF217u) % 6u)
					{
					case 5u:
					{
						int num5;
	...
	public static string _8tmmqFhFpUnpTGEL7HpnRhEGP7h(int int_0, string string_0 = "save")
	{
		if (!_DW9IcpdMEINZmuzfrqmwsduBGih.smethod_6(_QubTtSSHmMID5jdELnIaJMHe4Dz))
		{
			while (true)
			{
				...
				{
					uint num2;
					switch ((num2 = (uint)num ^ 0xA5EA6F0Eu) % 3u)
					{
					case 1u:
						_DW9IcpdMEINZmuzfrqmwsduBGih.smethod_7(_QubTtSSHmMID5jdELnIaJMHe4Dz);
						num = ((int)num2 * -1070390929) ^ 0x3D8269D1;
						continue;
					case 0u:
						break;
					default:
	...
	public static List<_3CCr8Bt1rkuzt0M6gYLbceJGV0p> _25D1ZH2er0EbpKmvFksAbFjP2OX(bool bool_0)
	{
		...
		{
			uint num3;
			switch ((num3 = (uint)num2 ^ 0x7B6AC36Eu) % 17u)
			{
			case 16u:
				break;
			case 15u:
			...
			case 10u:
				...
				continue;
			case 9u:
				num2 = (int)((num3 * 660033604) ^ 0x8139431);
				continue;
			case 8u:
			{
			...
			case 2u:
				num4 = 0;
				num2 = (int)((num3 * 354173565) ^ 0x2104D6E9);
				continue;
			case 1u:
				num++;
				num2 = 710739441;
	...
	public static _3CCr8Bt1rkuzt0M6gYLbceJGV0p _jVNnsNFMjoGC9t7v83qLI8vEZSH()
	{
		...
		{
			uint num2;
			switch ((num2 = (uint)num ^ 0xE05269F7u) % 26u)
			{
			case 25u:
				break;
			case 24u:
				num = ((int)num2 * -279844430) ^ 0x4DDAFF5C;
				continue;
			case 23u:
				dateTime2 = dateTime3;
				num = -1220224624;
			...
			case 22u:
			{
				...
				num = num14 ^ (int)(num2 * 1015588349);
				continue;
			}
			case 21u:
				dateTime2 = dateTime;
				num = (int)(num2 * 1298801017) ^ -543997507;
				continue;
			case 20u:
			{
				dateTime3 = _DW9IcpdMEINZmuzfrqmwsduBGih.smethod_10(string_);
				int num10;
				int num11;
			...
			case 15u:
			{
				...
				num = num12 ^ ((int)num2 * -1285414112);
				continue;
			}
			case 14u:
				num = (int)((num2 * 1516631098) ^ 0x522EA9C2);
				continue;
			case 12u:
				num3 = -1;
				num4 = 0;
				num = ((int)num2 * -793582942) ^ -1712917113;
				continue;
			case 11u:
				num5 = 0;
				num = (int)(num2 * 1622231798) ^ -176701437;
				continue;
			case 10u:
			{
				int num8;
			...
			case 7u:
				num3 = num4;
				num = (int)(num2 * 425169303) ^ -729117038;
				continue;
			case 6u:
				num4++;
				num = -754695014;
