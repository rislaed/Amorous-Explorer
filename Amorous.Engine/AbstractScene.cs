...
public abstract class AbstractScene
{
	...
	protected AbstractScene(IAmorous amorous)
	{
		...
		_PnkAlVnMv0SZvRBFexqzE5DF9tp.SetSkin("Assets/GUI/Squid/DefaultSkin", "Assets/GUI/Squid/DefaultSkin - Blue");
	}
	...
	{
		Texture2D texture2D_ = Game._uwNDZuqdFb9tyQtlQMxiz1DQ7x8.Load<Texture2D>(string_1);
	...
	private _kxm3yIqio0baXT5t5vOHBAEdviB _sjmRQFeAlNizCJ4EXsNrpUTpDYb(string string_0, int int_0, int int_1, int int_2, params string[] string_1)
	{
		...
		{
			list.Add(Game._uwNDZuqdFb9tyQtlQMxiz1DQ7x8.Load<Texture2D>(assetName));
		}
	...
	private _x1wxbalqqw8qtEqHC1UaGdv59Od _0YBRI5yp8d5OIyshYQBPSntvASC(string string_0, string string_1, int int_0, int int_1, string string_2, int int_2, int int_3, string string_3)
	{
		...
		{
			texture2D_2 = Game._uwNDZuqdFb9tyQtlQMxiz1DQ7x8.Load<Texture2D>(string_2);
		}
	...
	public virtual void Update(GameTime gameTime_0)
	{
		...
		{
			Layers = (from _ujAkjlfN5TywwbLAUDzPvtab6uJ_0 in Layers
		...
		_kmVTSqclXrApKmHKAamak6kRUjl(gameTime_0, Layers);
		...
		{
			bool bool_;
			if ((bool_ = Game._RbWJ7YGnYHCSoD44MRW1h5X6E7E._fy5ebLnmRsRXv9v7RKTFU5CGMaH(_PMeRYZJaBCqgB9uADJFP3c14lxq.LeftButton)) && _QLfEh7VVWqcVZ2VleBjZBbD78ng != null)
			{
				_QLfEh7VVWqcVZ2VleBjZBbD78ng._dGJ5R083rg1lKbVYP4W1TUEBqoh();
				_QLfEh7VVWqcVZ2VleBjZBbD78ng = null;
			}
			Microsoft.Xna.Framework.Point point_ = Game._vsceSzSIjBy2nZrCxAzKZbUiwLq._e6KgAy4CTN1JFYwA88grvAEmDxX(Game._RbWJ7YGnYHCSoD44MRW1h5X6E7E._U7CeYBJ1v1SoUxpX8emsQ9mWl5b);
			_MVL2E4AzcbNhDrRfPFXBDnmcJ4c(point_, bool_, Layers);
		}
	...
	private void _MVL2E4AzcbNhDrRfPFXBDnmcJ4c(Microsoft.Xna.Framework.Point point_0, bool bool_0, List<_ujAkjlfN5TywwbLAUDzPvtab6uJ> list_0)
	{
		...
		for (int num = list_0.Count - 1; num >= 0; num--)
		{
			...
			if ((ujAkjlfN5TywwbLAUDzPvtab6uJ2 is _x1wxbalqqw8qtEqHC1UaGdv59Od || ujAkjlfN5TywwbLAUDzPvtab6uJ2 is _z20t8IpBINiJtljSeTIkNoKUOkx || ujAkjlfN5TywwbLAUDzPvtab6uJ2 is _rmc1e7Ng50C4uLmgllAoRtxaZiB || ujAkjlfN5TywwbLAUDzPvtab6uJ2 is _3IHp43rpkJgOBcY9lrIrwMuwWve) && ujAkjlfN5TywwbLAUDzPvtab6uJ2._3ZeCDXqcWHY4XJDBGyav3UzxYaHA)
			{
				if (!(ujAkjlfN5TywwbLAUDzPvtab6uJ2 is _3IHp43rpkJgOBcY9lrIrwMuwWve))
				{
					...
					{
						rectangle.X = (int)ujAkjlfN5TywwbLAUDzPvtab6uJ2.X;
						rectangle.Y = (int)ujAkjlfN5TywwbLAUDzPvtab6uJ2.Y;
						rectangle.Width = ujAkjlfN5TywwbLAUDzPvtab6uJ2.Width;
						rectangle.Height = ujAkjlfN5TywwbLAUDzPvtab6uJ2.Height;
				...
				{
					_QGGOTxZ8aNWGh0hc26wcmx8wmwT NPC = ((_3IHp43rpkJgOBcY9lrIrwMuwWve)ujAkjlfN5TywwbLAUDzPvtab6uJ2).NPC;
					NPC._IvIFs0Tl6RHdTn3daJXsNCXCNyO = false;
					if (ujAkjlfN5TywwbLAUDzPvtab6uJ == null)
					{
						rectangle.X = (int)NPC._QGGOTxZ8aNWGh0hc26wcmx8wmwT_002EX;
						rectangle.Y = (int)NPC._QGGOTxZ8aNWGh0hc26wcmx8wmwT_002EY;
						rectangle.Width = (int)((float)NPC.Width * NPC._fO7gSlrDDNMoHR4FO5QXAq8fUyA);
						rectangle.Height = (int)((float)NPC.Height * NPC._fO7gSlrDDNMoHR4FO5QXAq8fUyA);
						if (NPC is _tfDAeR6npiqJMLRSXPO1DxGA0TgA)
						{
							rectangle.X -= rectangle.Width / 2;
							rectangle.Y -= rectangle.Height;
						}
						if (NPC._ZVpZ5Oing5kbbVhbmbOHyrofGH7 != null && rectangle.Contains(point_0))
						{
		...
		_QGGOTxZ8aNWGh0hc26wcmx8wmwT _4QLHHCk23T1BjK7acKxASbkCefG2 = ((_3IHp43rpkJgOBcY9lrIrwMuwWve)ujAkjlfN5TywwbLAUDzPvtab6uJ).NPC;
	...
	public virtual void Draw(SpriteBatch spriteBatch_0, SkeletonMeshRenderer skeletonMeshRenderer_0, Matrix matrix_0)
	{
		_rNZd4y7Vjg7H4PTzsnTaLEi5v8b(spriteBatch_0, skeletonMeshRenderer_0, matrix_0, Layers);
	}

	public virtual void Render(SpriteBatch spriteBatch_0)
	{
			...
			if (!(item is _3IHp43rpkJgOBcY9lrIrwMuwWve))
			{
				if (!(item is _WBXNT6eIVGk6ZKExRBJ6JxXE6zb))
				{
					...
					else
					{
						if (!flag)
						{
							spriteBatch_0.Begin(SpriteSortMode.Deferred, nullable_0: matrix_0, blendState_0: _XvcwmP1Eb6HFUF5pkiUVgpqNbWE);
							flag = true;
						}
						item.Draw(spriteBatch_0);
					}
				...
				wBXNT6eIVGk6ZKExRBJ6JxXE6zb.Draw(spriteBatch_0, skeletonMeshRenderer_0);
				if (!wBXNT6eIVGk6ZKExRBJ6JxXE6zb._zkHMlDFkja4TqmjdlHuZRCj8FCB)
				{
					wBXNT6eIVGk6ZKExRBJ6JxXE6zb._WBXNT6eIVGk6ZKExRBJ6JxXE6zb_002E_GDeKFFD8Rxnpsjzy36lUBxAEopc -= matrix_0.M41;
					wBXNT6eIVGk6ZKExRBJ6JxXE6zb._WBXNT6eIVGk6ZKExRBJ6JxXE6zb_002E_JpSvHH1W0gFCpaNEH5zB1qsDJXY -= matrix_0.M42;
	...
	private void _nrDmURIbDeklrMRB6X5y3IwhP1Q(_3IHp43rpkJgOBcY9lrIrwMuwWve _3IHp43rpkJgOBcY9lrIrwMuwWve_0, SpriteBatch spriteBatch_0, SkeletonMeshRenderer skeletonMeshRenderer_0, Matrix matrix_0)
	{
		...
		if (NPC is _tfDAeR6npiqJMLRSXPO1DxGA0TgA)
		{
			...
			{
				((_tfDAeR6npiqJMLRSXPO1DxGA0TgA)NPC)._QGGOTxZ8aNWGh0hc26wcmx8wmwT_002EX += matrix_0.M41;
				((_tfDAeR6npiqJMLRSXPO1DxGA0TgA)NPC)._QGGOTxZ8aNWGh0hc26wcmx8wmwT_002EY += matrix_0.M42;
			}
			((_tfDAeR6npiqJMLRSXPO1DxGA0TgA)NPC).Draw(spriteBatch_0, skeletonMeshRenderer_0);
			if (!NPC._zkHMlDFkja4TqmjdlHuZRCj8FCB)
			{
				((_tfDAeR6npiqJMLRSXPO1DxGA0TgA)NPC)._QGGOTxZ8aNWGh0hc26wcmx8wmwT_002EX -= matrix_0.M41;
				((_tfDAeR6npiqJMLRSXPO1DxGA0TgA)NPC)._QGGOTxZ8aNWGh0hc26wcmx8wmwT_002EY -= matrix_0.M42;
		...
		{
			spriteBatch_0.Begin(SpriteSortMode.Immediate, BlendState.NonPremultiplied, null, null, null, null, (!NPC._zkHMlDFkja4TqmjdlHuZRCj8FCB) ? matrix_0 : Matrix.Identity);
			((_xZgbANe7gi6i2DAhBEkKpR1QFLe)NPC).Draw(spriteBatch_0);
			spriteBatch_0.End();
		}
	}
	...
	{
		return Layers.FirstOrDefault((_ujAkjlfN5TywwbLAUDzPvtab6uJ _ujAkjlfN5TywwbLAUDzPvtab6uJ_0) => _ujAkjlfN5TywwbLAUDzPvtab6uJ_0 is _3IHp43rpkJgOBcY9lrIrwMuwWve && ((_3IHp43rpkJgOBcY9lrIrwMuwWve)_ujAkjlfN5TywwbLAUDzPvtab6uJ_0).NPC._9m9LEAgaqaeXydYhykSBmf9BrDG == npclocation_0) as _3IHp43rpkJgOBcY9lrIrwMuwWve;
	}
	...
	public _3IHp43rpkJgOBcY9lrIrwMuwWve _gWHVDvr9GDtRXP2zf2Md18MgZ4b(_QGGOTxZ8aNWGh0hc26wcmx8wmwT _QGGOTxZ8aNWGh0hc26wcmx8wmwT_0, LayerOrder LayerOrder_0)
	{
		_3IHp43rpkJgOBcY9lrIrwMuwWve _3IHp43rpkJgOBcY9lrIrwMuwWve2 = _VvFE2zgy4FbDjvaEvb67tXJ7aRm(_QGGOTxZ8aNWGh0hc26wcmx8wmwT_0.GetType().Name) ?? new _3IHp43rpkJgOBcY9lrIrwMuwWve(this, _QGGOTxZ8aNWGh0hc26wcmx8wmwT_0, LayerOrder_0);
		_3IHp43rpkJgOBcY9lrIrwMuwWve2.Layer = LayerOrder_0;
		_7oYtfGpL7UyAQrZxew7Ahbvj6Sv(_3IHp43rpkJgOBcY9lrIrwMuwWve2, (LayerOrder_0 == LayerOrder.Background) ? 1 : 3);
